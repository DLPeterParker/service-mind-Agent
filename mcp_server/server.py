"""MCP Server：通过 Streamable HTTP 暴露电商工具服务（本地 Python 函数如查订单、退款等 ）
                让大模型可以通过网络来调用这些工具。
...
from app.agent.tools.order import query_order as _query_order  # noqa: E402
from app.agent.tools.product import query_product as _query_product  # noqa: E402
from app.agent.tools.logistics import query_logistics as _query_logistics  # noqa: E402
from app.agent.tools.refund import apply_refund as _apply_refund  # noqa: E402
from app.agent.tools.knowledge import search_knowledge as _search_knowledge  # noqa: E402
